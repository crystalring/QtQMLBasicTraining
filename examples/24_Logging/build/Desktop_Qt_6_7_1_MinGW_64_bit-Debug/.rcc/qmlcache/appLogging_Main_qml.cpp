...
0x64,0x7,0x0,0x0,0x34,0x30,0x34,0x63,
...
0x0,0x0,0x0,0x0,0xbf,0x55,0x9f,0x38,
0x8b,0x51,0x63,0x47,0x1,0xc0,0x56,0xb4,
0x92,0xc4,0x2b,0x2e,0x0,0x0,0x0,0x0,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
0x0,0x0,0x0,0x0,0x23,0x0,0x0,0x0,
0x17,0x0,0x0,0x0,0x58,0x2,0x0,0x0,
...
0xa,0x12,0x14,0x18,0xb,0xac,0x4,0x7,
0x2,0xa,0x2e,0x5,0x18,0x7,0x2e,0x6,
0x18,0xa,0x12,0x16,0x18,0xb,0xac,0x7,
...
0xf,0x0,0x0,0x0,0x4c,0x0,0x6f,0x0,
0x67,0x0,0x67,0x0,0x69,0x0,0x6e,0x0,
0x67,0x0,0x43,0x0,0x61,0x0,0x74,0x0,
...
0x4c,0x0,0x6f,0x0,0x67,0x0,0x4c,0x0,
...
0x67,0x0,0x20,0x0,0x6d,0x0,0x65,0x0,
...
0xb,0x0,0x50,0x0,0xc,0x0,0xe0,0x0,
0x6c,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
0x6c,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
0xc,0x0,0x0,0x0,0x0,0x0,0x7,0x0,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
0xe,0x0,0xe0,0x0,0xe,0x0,0xf0,0x1,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
...
// expression for defaultLogLevel at line 14, column 14
int r2_0;
{
}
// generate_GetLookup
...
aotContext->setInstructionPointer(4);
#endif
aotContext->initGetEnumLookup(1, []() { static const auto t = QMetaType::fromName("QQmlLoggingCategory*"); return t; }().metaObject(), "DefaultLogLevel", "Warning");
...
Q_UNUSED(aotContext)
Q_UNUSED(argumentsPtr)
// expression for onCompleted at line 17, column 10
QObject *r2_0;
QObject *r2_2;
QString r11_0;
QString r2_1;
...
r2_1 = QStringLiteral("log message");
{
}
// generate_StoreReg
r11_0 = std::move(r2_1);
...
// generate_CallPropertyLookup
{
    ...
    QObject *firstArg = r10_0;
    const QLoggingCategory *category = aotContext->resolveLoggingCategory(firstArg, &firstArgIsCategory);
    if (category && category->isEnabled(QtDebugMsg)) {
        const QString message = (firstArgIsCategory ? QString() : (aotContext->engine->coerceValue<QObject *, QString>(r10_0).append(QLatin1Char(' ')))).append(std::move(r11_0));
...
// generate_LoadRuntimeString
r2_1 = QStringLiteral("warning message");
{
}
// generate_StoreReg
r11_0 = std::move(r2_1);
...
{
    bool firstArgIsCategory = false;
    QObject *firstArg = r10_1;
    const QLoggingCategory *category = aotContext->resolveLoggingCategory(firstArg, &firstArgIsCategory);
    if (category && category->isEnabled(QtWarningMsg)) {
        const QString message = (firstArgIsCategory ? QString() : (aotContext->engine->coerceValue<QObject *, QString>(r10_1).append(QLatin1Char(' ')))).append(std::move(r11_0));
        aotContext->setInstructionPointer(35);
        aotContext->writeToConsole(QtWarningMsg, message, category);
    }
}
{
}
